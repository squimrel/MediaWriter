...
const char* HelperError::what() const noexcept {
    switch (m_error) {
        case Error::DECOMPRESS_INIT:
            return "Couldn't initalize decompressor.";
        case Error::DECOMPRESS_MEM:
            return "Not enough memory to decompress the file \"%1\".";
        case Error::DECOMPRESS_OPTIONS:
            return "Unknown options passed to decompressor.";
        case Error::DECOMPRESS_UNKNOWN:
            return "Unknown error occurred while decompressing.";
        case Error::FILE_CORRUPT:
            return "The file \"%1\" is corrupted.";
        case Error::FILE_READ:
            return "Can't open \"%1\" for reading.";
        case Error::DRIVE_USE:
            return "Failed to use the drive \"%1\". Make sure the drive is not in use by another program.";
        case Error::DRIVE_WRITE:
            return "Failed to write to drive \"%1\". Make sure the drive is not in use by another program.";
        case Error::DRIVE_DAMAGED:
              return "The drive \"%1\" is probably damaged.";
